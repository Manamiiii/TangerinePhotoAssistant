...
- 相册默认把视觉相似连拍折叠为组卡片，也可展开全部；组卡片优先显示人工保留照片，并显示保留、未处理和总张数。
- Mac 隔离演示库预置连拍保留、多张保留、非连拍保留/淘汰和人工拆分样例；“全部照片”保持展开，进入相册详情后默认折叠。
...
- 单张照片可在相册中直接保留或淘汰；连拍在组内对比后选择。批量勾选仅用于归入相册和导出，与持久的“保留”状态明确区分。
